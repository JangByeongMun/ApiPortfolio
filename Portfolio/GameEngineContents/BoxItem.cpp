...
void BoxItem::SetType(BoxType _Type)
{
	...
	GameEngineSound::SoundPlayOneShotWithVolume("chest drop 1.wav", 0, 0.1f * Option_SFX);
...
void BoxItem::OpenStart()
{
	...
	GameEngineSound::SoundPlayOneShotWithVolume("chest open 1.wav", 0, 0.1f * Option_SFX);
}
